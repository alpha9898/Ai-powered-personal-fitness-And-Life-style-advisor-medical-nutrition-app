...
class ArticlesitemDetalis extends StatelessWidget {
  final Articalentity articalentity;
  const ArticlesitemDetalis({super.key, required this.articalentity});
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: NetworkImage(articalentity.image!),
                          fit: BoxFit.cover),
                    ),
                  ),
                ),
